...
//com_ningso_libcurl_
    ...
    cls = env->FindClass("com/ningso/libcurl/Curl$ReadCallback");
    if (cls == NULL) {
       return JNI_ERR;
    }
...
JNIEXPORT int JNICALL Java_com_ningso_libcurl_Curl_curlEasySetoptFunctionNative
